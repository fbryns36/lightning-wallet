<p align="center">
  <b>lightning-wallet</b>
</p>

<p align="center">
  <sub>lnd · channel · invoice</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>LnWallet</code> &nbsp;·&nbsp; <code>lnwallet</code>
</p>
...
Lightning wallet front-end — channel list, invoice decode, peer connect stubs.

Pairs with lnd repos people already star.
...
```bash
dotnet restore lightning-wallet.slnx
dotnet build lightning-wallet.slnx -c Release
dotnet test lightning-wallet.slnx -c Release
```
